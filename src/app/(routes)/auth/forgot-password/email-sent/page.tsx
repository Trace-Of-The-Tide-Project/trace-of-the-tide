          ...
          <HexagonCard size="compact">
            <div className="w-full max-w-md flex flex-col items-center text-center">
              ...
              <button
                ...
                className="w-full py-3 rounded-lg font-medium transition-colors disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer select-none border text-neutral-100"
                style={{
