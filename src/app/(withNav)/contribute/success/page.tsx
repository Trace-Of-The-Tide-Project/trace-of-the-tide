    ...
    >
      ...
      <div className="relative z-10 flex min-h-[60vh] flex-col items-center justify-center px-6 py-12">
        <div className="flex w-full max-w-md flex-col items-center text-center">
          <div
            className="mb-6 flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-green-500"
            aria-hidden
          >
            <CheckIcon />
          </div>
          ...
          <Link
            href="/"
            className="inline-block rounded-lg px-5 py-2 text-center text-sm font-medium text-white transition-opacity hover:opacity-90"
